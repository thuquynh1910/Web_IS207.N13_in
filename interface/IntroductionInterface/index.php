...
<body>
    <div class="app">
        ...
        <div class="container-2">
            <div id="menu">
                <ul>
                    ...
                    <li class="list_menu">
                        <a class="text-1" href="../product interface/index.php">SẢN PHẨM</a>
                    </li>
                    <li class="list_menu">
                        <a class="text-1" href="">KHUYẾN MÃI</a>
                    </li>
                    <li class="list_menu">
                        <a class="text-1" href="./index.php">GIỚI THIỆU</a>
                    </li>
                    <li class="list_menu">
        ...
        <div class="container-3">
            <div class="store-2" style="background-image: url('./assets/img/banner-1-1\ 1.png');">
                <div class="store-2-info">
                    <p class="text-3">GIỚI THIỆU</p>
                    <P class="text-4">Nhóm 7.1 / Walky Store</P>
                </div>
            </div>
        </div>
        ...
        <div class="container-4">
            <ul class="hinh12">
                <img class="hinh-2" src="./assets/img/Hình 2.png">
            </ul>

            <ul class="diemso">
                <p class="diemso-1">Walky Store - Nhịp nhàng trên từng bước trên từng bước chân</p>
                <li class="diemso-2">Chào mừng bạn đến với ngôi nhà Walky Store! Tại đây, mỗi một dòng chữ, mỗi chi tiết và hình ảnh đều là những bằng chứng mang dấu ấn lịch sử 2 năm, và đang không ngừng phát triển lớn mạnh.</li>
            </ul>
        </div>
        ...
        <div class="container-6">
            <p class="nhom">Nhóm 7.1</p>
            <div class="day">
                <div class="list-member">
                    <ul class="list-name">
                        <li>1/ Nguyễn Quốc Huy</li>
                        <li>2/ Đặng Thị Thanh Ngân</li>
                        <li>3/ Hoàng Thu Phương</li>
                        <li>4/ Trần Thu Quỳnh</li>
                    </ul>
                ...
                <div class="hinh">
                    <img class="hinh-3" src="./assets/img/Hình 3.png">
                </div>
            </div>
        </div>
        ...
        <div class="container-7">
            <div class="store-5">
                <img class="define-img" src="./assets/img/Hình 5.png">
            </div>
        </div>
